package com.ram.command.practice.RestaurantOrderManagementSystem.Commands.CokeCommands;
...
public class OrderCokeCommand extends Command {
    ...
    public OrderCokeCommand(Order order,
