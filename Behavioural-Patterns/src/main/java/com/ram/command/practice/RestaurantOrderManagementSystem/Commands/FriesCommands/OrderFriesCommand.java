package com.ram.command.practice.RestaurantOrderManagementSystem.Commands.FriesCommands;
...
public class OrderFriesCommand extends Command {
    ...
    public OrderFriesCommand(Order order,
