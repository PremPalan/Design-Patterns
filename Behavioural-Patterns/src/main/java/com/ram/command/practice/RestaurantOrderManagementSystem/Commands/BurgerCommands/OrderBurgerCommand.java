package com.ram.command.practice.RestaurantOrderManagementSystem.Commands.BurgerCommands;
...
public class OrderBurgerCommand extends Command {
    ...
    public OrderBurgerCommand(Order order,
